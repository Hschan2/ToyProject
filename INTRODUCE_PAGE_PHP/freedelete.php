<!DOCTYPE HTML>
					<?php 
						...
						$query = "select id, title from freeboard where id = $id";
		...
		<div id="main">
			<div class="container">
				<div class="row">
					...
					<form action="freedeleteok.php?id=<?php echo $rows['id'] ?>" method="POST">
			        <table class="table table-bordered">
					<tr>
						<td colspan="2"><input type="password" placeholder="삭제하기 위한 비밀번호를 입력하세요." name="pass" class="form-control"/></td>
					</tr>
  		           <tr>
               	   <td colspan="2">
                    <input type="submit" class="buttonright" value="삭제" class="pull-right"/>
